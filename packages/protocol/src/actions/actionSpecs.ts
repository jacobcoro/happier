...
export const ACTION_SPECS: readonly ActionSpec[] = Object.freeze([
  ...
  },
  {
    id: 'session.pin',
    title: 'Pin session',
    description: 'Pin the specified session so it stays at the top of the session list.',
    safety: 'safe',
    approval: APPROVAL_RESULT_NONE,
    placements: [],
    bindings: { mcpToolName: 'session_pin' },
    examples: {
      mcp: { argsExample: '{"sessionId":"{{sessionId}}"}' },
    },
    surfaces: {
  ...
  },
  {
    id: 'session.unpin',
    title: 'Unpin session',
    description: 'Remove the pin from the specified session.',
    safety: 'safe',
    approval: APPROVAL_RESULT_NONE,
    placements: [],
    bindings: { mcpToolName: 'session_unpin' },
    examples: {
      mcp: { argsExample: '{"sessionId":"{{sessionId}}"}' },
    },
    surfaces: {
    ...
    inputHints: {
      title: 'Unpin a session',
      fields: [{ path: 'sessionId', title: 'Session id', widget: 'text', required: true }],
    },
    inputSchema: SessionIdRequiredInputSchema,
  },
  {
    id: 'session.pins.list',
    title: 'List pinned sessions',
    description: 'List the account\'s pinned sessions so a caller can read a pin back from the server.',
    safety: 'safe',
    approval: APPROVAL_RESULT_REQUIRED,
    placements: [],
    bindings: { mcpToolName: 'session_pins_list' },
    examples: {
      mcp: { argsExample: '{}' },
    },
    surfaces: {
